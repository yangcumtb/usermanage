package cn.hnsl.gen.modular.controller;

import cn.hnsl.gen.core.enums.GenDownloadEnum;
import cn.hnsl.gen.core.enums.GenSessionKeyFlags;
import cn.hnsl.gen.core.generator.base.model.ContextParam;
import cn.hnsl.gen.core.generator.guns.GunsExecutor;
import cn.hnsl.gen.core.util.ConcatUtil;
import cn.hnsl.gen.core.util.FieldsConfigHolder;
import cn.hnsl.gen.modular.model.FieldConfig;
import cn.hnsl.gen.modular.model.GenSessionFieldConfigs;
import cn.hnsl.gen.modular.model.params.ExecuteParam;
import cn.hnsl.gen.modular.model.params.SaveFieldConfigParam;
import cn.hnsl.gen.modular.service.GenerateService;
...
import cn.hnsl.gen.core.generator.restful.RestfulApiExecutor;
import cn.hnsl.gen.core.generator.restful.mybatisplus.param.MpParam;
...
public class GeneratorController {
    ...
    public ResponseEntity execute(ExecuteParam executeParam) {
        ...
        if (Objects.equals(GenDownloadEnum.DEFAULT_PATH.name(), executeParam.getGenLocation())) {
            ...
            outputPath = new File("").getAbsolutePath() + File.separator + "hnsl-main" + File.separator + "src" + File.separator + "main";
