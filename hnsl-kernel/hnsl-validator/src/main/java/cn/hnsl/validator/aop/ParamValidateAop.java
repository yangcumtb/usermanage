 ...
 */
package cn.hnsl.validator.aop;

import cn.hnsl.validator.util.CheckUtil;
import cn.hnsl.model.constants.AopSortConstants;
...
public class ParamValidateAop {
    ...
    @Pointcut(value = "@annotation(cn.hnsl.validator.stereotype.ParamValidator)")
