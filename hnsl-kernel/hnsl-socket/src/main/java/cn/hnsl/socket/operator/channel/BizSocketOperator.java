package cn.hnsl.socket.operator.channel;
 ...
 */
public class BizSocketOperator implements SocketChannelExpandInterFace {
    ...
    public BizSocketOperator(Session socketChannel) {
