...
package cn.hnsl.sys.core.exception.enums;
...
public enum BizExceptionEnum implements AbstractExceptionEnum {
    ...
    PHONE_ALREADY_REG("400", "该手机号已经注册"),
    ...
    BizExceptionEnum(String errorCode, String userTip) {
    ...
    public void setMessage(String userTip) {
        this.userTip = userTip;
    }
}
