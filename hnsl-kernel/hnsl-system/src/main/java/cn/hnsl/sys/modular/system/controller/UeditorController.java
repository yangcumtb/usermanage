...
import cn.hnsl.sys.core.util.UeditorUtil;
import cn.hutool.core.io.resource.ResourceUtil;
import cn.hnsl.sys.modular.system.model.UeditorFileResult;
...
public class UeditorController {
    ...
    public void getConfigInfo(HttpServletResponse response) {
        try {
            ...
            throw new ServiceException(BizExceptionEnum.UE_CONFIG_ERROR);
        }
    }
