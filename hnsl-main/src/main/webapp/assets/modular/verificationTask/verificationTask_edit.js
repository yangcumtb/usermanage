...
layui.use(['form', 'admin', 'HttpRequest', 'laydate', 'upload', 'layarea', 'formSelects', 'carousel'], function () {
    ...
    //获取详情信息，填充表单
    var ajax = new HttpRequest(Feng.ctxPath + "/verification/verificationTask/detail?id=" + Feng.getUrlParam("id"), "get");
    var result = ajax.start();
    form.val('verificationTaskForm', result.data);
    form.val('verificationTaskForm2', result.data);
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new HttpRequest(Feng.ctxPath + "/verification/verificationTask/edit", 'post', function (data) {
            Feng.success("更新成功！");
            window.location.href = Feng.ctxPath + '/verification/verificationTask'
        }, function (data) {
