...
layui.use(['layer', 'form', 'admin', 'laydate', 'HttpRequest', 'iconPicker'], function () {
    ...
    //获取菜单信息
    var ajax = new HttpRequest(Feng.ctxPath + "/system/menu/getMenuInfo?menuId=" + Feng.getUrlParam("menuId"), "get");
    ...
    $('#parentName').click(function () {
        ...
        layer.open({
            ...
            content: Feng.ctxPath + '/system/commonTree?formName=' + formName + "&formId=" + formId + "&treeUrl=" + treeUrl,
                ...
                $("#parentName").val(MenuInfoDlg.data.pcodeName);
            }
        });
    });
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new HttpRequest(Feng.ctxPath + "/system/menu/edit",'post', function (data) {
            Feng.success("修改成功！");
