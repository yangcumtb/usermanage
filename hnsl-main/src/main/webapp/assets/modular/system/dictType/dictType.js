layui.use(['table', 'HttpRequest', 'func'], function () {
        ...
        return [[
            ...
            {field: 'dictTypeId', hide: true, title: '字典类型id'},
            {
                field: 'name', align: "center", sort: true, title: '类型名称', templet: function (d) {
                    var url = Feng.ctxPath + '/system/dict?dictTypeId=' + d.dictTypeId;
    ...
    DictType.openAddDlg = function () {
        func.open({
            width: "1000rem",
            title: '添加字典类型',
            content: Feng.ctxPath + '/system/dictType/add',
    ...
    DictType.openEditDlg = function (data) {
        func.open({
            width: "1000rem",
            title: '修改字典类型',
            content: Feng.ctxPath + '/system/dictType/edit?dictTypeId=' + data.dictTypeId,
            tableId: DictType.tableId
        });
    };
    ...
    DictType.onDeleteItem = function (data) {
        ...
        var operation = function () {
            var ajax = new HttpRequest(Feng.ctxPath + "/system/dictType/delete",'post', function (data) {
                Feng.success("删除成功!");
                table.reload(DictType.tableId);
            }, function (data) {
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/system/dictType/list',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
