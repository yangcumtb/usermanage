layui.use(['table', 'layarea', 'admin', 'form', 'HttpRequest', 'func', 'upload', 'element', 'layer'], function () {
    ...
    var uploadListIns = upload.render({
        elem: '#testList',
        elemList: $('#fileList'),
        url: Feng.ctxPath + '/prominemanger/recoveredspot/proImportShp?spotType=' + spotType,
        accept: 'file',
        exts: 'zip',
        multiple: false,
        auto: false,
        ...
        before: function (obj) {
            ...
            this.url = Feng.ctxPath + '/prominemanger/recoveredspot/proImportShp?spotType=' + spotType;
