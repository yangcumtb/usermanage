layui.use(['table', 'admin', 'HttpRequest', 'form', 'func'], function () {
    var $ = layui.$;
    ...
    Position.openAddDlg = function () {
        func.open({
            width: "1000rem",
            title: '添加职位',
            content: Feng.ctxPath + '/system/post/add',
    ...
    Position.openEditDlg = function (data) {
        func.open({
            width: "1000rem",
            title: '修改职位',
            content: Feng.ctxPath + '/system/post/edit?positionId=' + data.positionId,
            tableId: Position.tableId
        });
    };
    ...
    Position.onDeleteItem = function (data) {
        var operation = function () {
            var ajax = new HttpRequest(Feng.ctxPath + "/system/post/delete",'post', function (data) {
                Feng.success("删除成功!");
                table.reload(Position.tableId);
            }, function (data) {
    ...
    Position.changeStatus = function (positionId, checked) {
        var ajax = new HttpRequest(Feng.ctxPath + "/system/post/changeStatus",'post', function (data) {
            Feng.success("修改成功!");
        }, function (data) {
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/system/post/list',
        page: true,
        height: "full-100",
        cellMinWidth: 100,
