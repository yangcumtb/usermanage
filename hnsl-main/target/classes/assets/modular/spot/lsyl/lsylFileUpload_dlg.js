layui.use(['admin', 'HttpRequest', 'upload', 'form', 'layer', 'element'], function () {
    ...
    var fileBusinessName = "卫星影像图"

    var associateid;

    //获取associateid
    var ajaxassociateid = new HttpRequest(Feng.ctxPath + '/spot/lsyl/detail?id=' + keyIdValue, 'get');
    ...
    $.ajax({
        type: 'get',
        url: Feng.ctxPath + '/spot/lsyl/fileDetail/' + $("#keyIdValue").val(),
                ...
                if (res.data[i].fileBusinessName == "规划图" || res.data[i].fileBusinessName == "图斑影像图" || res.data[i].fileBusinessName == "核查") {
                    ...
                    tr.find('.file-delete').on('click', function (data) {
                        ...
                        var operation = function () {
                            ...
                            var ajax = new HttpRequest(Feng.ctxPath + '/spot/lsyl/deleteFileByFileId', 'post', function (data) {
                                Feng.success("删除成功!");
                                tr.remove();
                            }, function (data) {
