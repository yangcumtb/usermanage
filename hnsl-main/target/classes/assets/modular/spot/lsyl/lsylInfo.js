layui.use(['table', 'layarea', 'admin', 'form', 'HttpRequest', 'func'], function () {
    ...
    lsylInfo.initColumn = function () {
        return [[
            ...
            {
                field: 'zthb', title: '主体编号', sort: true, width: 180, templet: function (param) {
                    if (param.ztbh == null) {
                        return "";
                    } else {
                        return param.ztbh;
            ...
            {fixed: 'right', width: 330, toolbar: "#tool", title: '操作'}
        ]];
    };
    ...
    lsylInfo.openAddDlg = function () {
        func.open({
            width: "1000rem",
            title: '添加历史遗留矿山信息表',
            content: Feng.ctxPath + '/spot/lsyl/add',
    ...
    lsylInfo.openEditDlg = function (data) {
        func.open({
            width: "1000rem",
            title: '修改历史遗留矿山信息表',
            content: Feng.ctxPath + '/spot/lsyl/edit?id=' + data.id,
            tableId: lsylInfo.tableId
        });
    };
    /**
    ...
    lsylInfo.openDetailDlg = function (data) {
        func.open({
            ...
            title: '历史遗留矿山详情',
            // height: '650',
            content: Feng.ctxPath + '/spot/lsyl/detailHtml?id=' + data.id,
            tableId: lsylInfo.tableId
        });
    };
    /**
    ...
    lsylInfo.batchInsertByExcel = function () {
        layer.open({
            ...
            content: Feng.ctxPath + '/spot/lsyl/batchImport'
        });
    };
